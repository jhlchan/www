...
include-after: |
    ...
    <!-- python -m http.server, URL: http://0.0.0.0:8000/demo/demo09z.html -->
    <!-- file:///Users/josephchan/jc/www/python/pyscript/demo/demo09z.html -->
---
...
http://0.0.0.0:8000/examples/demo18.html

When [[fetch]] uses files = ["examples/palettes.py", "examples/fractals.py"]
The names of modules are: examples.palettes, examples.fractals.

http://0.0.0.0:8000/examples/demo18.html
Computing Mandelbrot set ...
mandelbrot: 1243ms - timer ended
Computing Julia set ...
julia: 727ms - timer ended
Computing Newton set ...
newton: 759ms - timer ended

http://0.0.0.0:8000/demo09a.html
Computing Mandelbrot set
mandelbrot: 9514ms - timer ended
Computing Julia set
julia: 5409ms - timer ended
Computing Newton set ...
newton: 8029ms - timer ended
...
<py-config>
    ...
    [[fetch]]
    files = ["examples/palettes.py", "examples/fractals.py"]
</py-config>
<py-script>
    ...
    from examples.fractals import mandelbrot, julia, newton
...
<!-- pandoc -s demo09z.md -o demo09z.html -->