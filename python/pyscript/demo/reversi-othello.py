...
#
# 1 COMMENT
# Grant Jenks 6 years, 3 months ago  # | flag
# I hadn't realized there were so many AI options in Othello. Yay! I learned something. Thanks for sharing.
#
# Other people interested in learning the basics should check out Free Python Games at http://www.grantjenks.com/docs/freegames/ Lot's of classics there but no Othello... yet.
#
# Would you be interested in contributing an Othello variation to Free Python Games?
#
